...
def main():
    ...
    if 'WEBSITE_HOSTNAME' not in os.environ:
        ...
        load_dotenv('./.env')
    #si la variable de entorno WEBSITE_HOSTNAME existe (que es la que mme da azure), ejecuto el archivo de produccion, de lo contrario, activa el settings normal
